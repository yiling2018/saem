...
def main():
    ...
    parser.add_argument("--bert_path",
                        default='/media/ling/datum/Datasets/word_embeddings/uncased_L-12_H-768_A-12/',
                        type=str,
                        help="The BERT model path.")
    parser.add_argument("--txt_stru", default='cnn',
                        help="Whether to use pooling or cnn or rnn")
    parser.add_argument("--trans_cfg", default='/media/ling/datum/workspace/SCAN/image_bert.json',
